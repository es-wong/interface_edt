...
errorbar(T(phys_diff_idx:end,1),N_free(phys_diff_idx:end,1),N_free(phys_diff_idx:end,2),'Color',colSet_black(t_max,:),'Marker','.','LineWidth',3,'MarkerFaceColor',colSet_black(t_max,:), 'MarkerSize',40);
