...
% field5 = 'index_5';
% value5 = 500;
B = struct(field1,value1,field2,value2); %create the structure
...
figuresdir1 = 'C:\Users\Eric\Desktop\Admittance\ZnO-PbS\light_soak_study\IR_soak\sanity_checks\real_cell\blue_light\data\full_run\analysis\TAS';
...
fitidx(1,2) = find(fit_round(:,4) == 6.283e6); %input the final boundary condition
...
%     set(t,'Interpreter', 'Latex')
    ...
    set(x,'FontName','Calibri');
    set(gca,'FontSize',40);
    y = ylabel ('ln(^{1}/_{\omega_0})', 'FontSize',40);
    set(y,'FontName', 'Calibri')
